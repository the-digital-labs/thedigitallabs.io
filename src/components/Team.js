      ...
      <Grid container className={classes.teamContent} id="team-content">
        ...
        <Grid className={classes.profileCard + ' team-profile'} item xl={12} lg={12} md={12} sm={12} xs={12}>
          <Grid container>
            ...
            <Grid item xl={9} lg={8} md={12} sm={12} xs={12}>
              <Typography className={classes.profileName + ' team-profile-name'}>Christopher Trimboli</Typography>
        ...
        <Grid className={classes.profileCard + ' team-profile'} item xl={12} lg={12} md={12} sm={12} xs={12}>
          <Grid container>
            ...
            <Grid item xl={9} lg={8} md={12} sm={12} xs={12}>
              <Typography className={classes.profileName + ' team-profile-name'}>Sylvia Makuch</Typography>
